...
abstract class ParkingPrice implements IParkingPrice
{
    ...
    {
        $minutes = Carbon::now(new \DateTimeZone('America/Sao_Paulo'))
    ...
    public function calculate(): float|int
    {
        ...
        if ($permanence['minutes'] <= self::PERMANENCE_MINUTES_FREE) return 0;
